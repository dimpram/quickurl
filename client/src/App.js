  ...
  return (
    <>
      ...
      <Section color="#ffffff" name="about">
        ...
        <Container>
          <Title>About</Title>
          <Text>QuickURL is a small full stack project made by Dimitris Pramateftakis. You can find the source code down at the footer so feel free to make any contributions! Also, in the table below are some public stats about the URLs.</Text>
          <Table />
        </Container>
      </Section>
